<?php
    ...
    $requestedEndpoint = '/backoffice/acs-app/api/phonebook.php';
    $currentEndpoint = parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH);

    if ($_SERVER['REQUEST_METHOD'] === 'GET' && $currentEndpoint === $requestedEndpoint) {
        $query = 'SELECT * FROM phonebooks ORDER BY contact_id ASC';
