<?php
	...
	if (!$_SESSION["user_name"]) {  //check session
		...
		if(!empty($_POST)) {
			...
			$str_sql = "INSERT INTO reportpay_tb1 (repp_id, repp_date, repp_paydate, repp_desc_summarize, repp_date_summarize, repp_desc_balance, repp_date_balance, repp_total_summarize, repp_total_balance, repp_file, repp_year, repp_month, repp_depid, repp_userid_create, repp_createdate, repp_userid_edit, repp_editdate) VALUES (";
			$str_sql .= "'" . $nextreppno . "',";
			$str_sql .= "'" . $repdate . "',";
			$str_sql .= "'" . $reppaydate . "',";
