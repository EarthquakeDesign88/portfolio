...
<body>
	...
	<section>
		<div class="container">
			...
			<form method="POST" name="frmReceiptCEO" id="frmReceiptCEO" action="">
				
				<div class="row py-4 px-1" style="background-color: #E9ECEF">
					<div class="col-md-12">
						<h3 class="mb-0">
							<i class="icofont-money-bag"></i>&nbsp;&nbsp;สรุปรายรับ
						</h3>
					</div>
			...
			$("#btnSearch").click(function() {
				if($('#SelMonth').val() == '') {
					swal({
						...
						frmReceiptCEO.SelMonth.focus();
					});
				} else {
					$.ajax({
						type: "POST",
						url: "r_report_receipt_ceo.php",
						data: $("#frmReceiptCEO").serialize(),
						success: function(result) {
							if(result.status == 1) {
								window.location = "report_receipt_ceo_desc.php?cid=" + result.compid + "&dep=" + result.depid + "&m=" + result.SelMonth;
							} else {
