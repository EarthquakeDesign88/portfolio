		...
		<div class="container">
			...
			<form method="POST" name="" id="" action="">
				...
				<div class="row py-4 px-1" style="background-color: #E9ECEF">
					<div class="col-md-12">
						<h3 class="mb-0">
							<i class="icofont-company"></i>&nbsp;&nbsp;เลือกฝ่าย ( ออกรายงายใบสำคัญจ่าย )
						</h3>
					</div>
				...
				<div class="row py-4 px-1" style="background-color: #FFFFFF">
					...
					<?php
						...
						while ($obj_row = mysqli_fetch_array($obj_rs)) {
							...
							$str_sql_iv = "SELECT * FROM invoice_tb WHERE inv_depid = '". $obj_row["dep_id"] ."' AND inv_statusMgr = 1 AND inv_apprMgrno <> '' AND inv_NostatusPaym = ''";
					...
					<div class="col-md-3 my-3">
						<a href="report_payment.php?cid=<?=$cid;?>&dep=<?= $obj_row["dep_id"]; ?>">
							<div class="card-counter <?= $obj_row["dep_name"]; ?>">
								<i class="icofont-paper"></i>
								<span class="count-title" style="margin-top: 30px"><?= $depname; ?></span>
