				...
				<div class="row py-4 px-1" style="background-color: #FFFFFF">
					...
					<div class="col-md-12">
						<div class="row mx-0">
							...
							<div class="col-md-1" style="line-height: 15px; padding-top: 20px;  font-size: 14px;">
								จ่าย<br>Pay
							</div>
							...
							<div class="col-md-1 text-center" style="line-height: 15px; padding-top: 20px; font-size: .9rem;">
								หรือผู้ถือ<br>Or Bearer
							</div>
						</div>
					</div>
					...
					<div class="col-md-12 pb-2">
						<div class="row mx-0">
							...
							<div class="col-md-10" style="border-bottom: 1px dotted #000; padding-top: 20px;">
					...
					<div class="col-md-12 py-2">
						<div class="row mx-0">
							...
							<div class="col-md-6" style="border-bottom: 1px dotted #000; top: -17px; left: 15px"> 
							</div>
                            <div class="col-md-1" style="line-height: 15px; padding-top: 20px; font-size: 14px; text-align:end;">
                                บาท <br> Bath
                            </div>
