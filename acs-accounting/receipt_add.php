								...
								<div class="col-md-3 pl-1">
									<div class="row">
										<div class="col-md-12">
											...
											<input type="text" class="form-control my-1 text-right" name="amount1" id="amount1" autocomplete="off" tabindex="8" value="<?=number_format($obj_row["invrcpt_amount1"],2);?>">
											<input type="text" class="form-control text-right my-1 d-none" name="amountHidden1" id="amountHidden1" value="<?=$obj_row["invrcpt_amount1"];?>" readonly>
								...
								<div class="col-md-3">
									<div class="row">
										<div class="col-md-12">
											...
											<input type="text" class="form-control text-right my-1" name="amount1" id="amount1" autocomplete="off" value="<?=number_format($obj_row["invrcpt_amount1"],2);?>">
