var Select=function(t,i){
	...
	this.init=function(){
		switch(typeof t){
			case"object":this.target=t;
			break;
			case"string":this.target=document.querySelector(t)
		}
	...
	this.buildSelect=function(){
		...
		("auto"===this.settings.filtered&&this.options.length>=this.settings.filter_threshold||this.settings.filtered===!0)&&(this.isLarge=!0,this.select.classList.add("large"))
	},
	this.buildList=function(){
		...
		this.buildFilter(),this.buildOptions(),
