				...
				<div class="row py-4 px-1" style="background-color: #FFFFFF">
					...
					<div class="col-md-3 pt-1 pb-3">
						...
						<div class="input-group">
							...
							<input type="date" class="form-control" name="Redate" id="Redate" autocomplete="off" value="<?=$obj_row["re_date"];?>" tabindex="2">
						</div>
					</div>
					...
					<div class="col-md-3 pt-1 pb-3">
						...
						<div class="input-group">
							...
							<select class="custom-select form-control" name="SelMonth" id="SelMonth" tabindex="3">
					...
					<div class="col-md-12 pt-1 pb-3" id="showDataCust">
						...
						<div class="input-group">
							...
							<input type="text" name="searchCustomer" id="searchCustomer" class="form-control" placeholder="กรอกบางส่วนของชื่อ-นามสกุล/ชื่อบริษัท" autocomplete="off" value="<?=$obj_row["cust_name"];?>" tabindex="4">
					...
					<div class="col-md-12 pt-1 pb-3">
						...
						<div class="input-group">
							...
							<input type="text" class="form-control" name="outputTax" id="outputTax" autocomplete="off" placeholder="กรุณากรอกรายละเอียดภาษีขาย" value="<?=$obj_row["re_outputtax"];?>" tabindex="5">
						</div>
					</div>
										...
										<div class="col-md-12">
											...
											<div class="row">
												<div class="col-md-9 pr-1">
													<input type="text" class="form-control my-1" name="invredesc1" id="invredesc1" autocomplete="off" tabindex="6" value="<?=$obj_row["re_description1"];?>" placeholder="กรอกรายละเอียด">
													<input type="text" class="form-control my-1" name="invredesc2" id="invredesc2" autocomplete="off" tabindex="9" value="<?=$obj_row["re_description2"];?>" placeholder="กรอกรายละเอียด">
													<input type="text" class="form-control my-1" name="invredesc3" id="invredesc3" autocomplete="off" tabindex="12" value="<?=$obj_row["re_description3"];?>" placeholder="กรอกรายละเอียด">
													<input type="text" class="form-control my-1" name="invredesc4" id="invredesc4" autocomplete="off" tabindex="15" value="<?=$obj_row["re_description4"];?>" placeholder="กรอกรายละเอียด">
													<input type="text" class="form-control my-1" name="invredesc5" id="invredesc5" autocomplete="off" tabindex="18" value="<?=$obj_row["re_description5"];?>" placeholder="กรอกรายละเอียด">
													<div class="row px-0">
														<div class="col-md-9 pr-1">
															<input type="text" class="form-control" name="invredesc6" id="invredesc6" autocomplete="off" tabindex="21" value="<?=$obj_row["re_description6"];?>" placeholder="กรอกรายละเอียด">
														</div>
														<div class="col-md-3 pl-1">
															<input type="text" class="form-control text-right" name="invresubdesc6" id="invresubdesc6" autocomplete="off" tabindex="22" value="<?=$obj_row["re_sub_description6"];?>" placeholder="กรอกจำนวนหน่วยคูณ">
															<input type="text" class="form-control text-right d-none" name="invresubdescHidden6" id="invresubdescHidden6" value="<?=$obj_row["re_sub_description6"];?>">
														</div>
													</div>
													
													<input type="text" class="form-control my-1" name="invredesc7" id="invredesc7" autocomplete="off" tabindex="25" value="<?=$obj_row["re_description7"];?>" placeholder="กรอกรายละเอียด">
													<input type="text" class="form-control my-1" name="invredesc8" id="invredesc8" autocomplete="off" tabindex="28" value="<?=$obj_row["re_description8"];?>" placeholder="กรอกรายละเอียด">
												</div>
												<div class="col-md-3 pl-1">
													<input type="text" class="form-control my-1 text-center" name="invresubdesc1" id="invresubdesc1" tabindex="7" autocomplete="off" value="<?=$obj_row["re_sub_description1"];?>" placeholder="กรอกเฉพาะตัวอักษร">

													<input type="text" class="form-control my-1 text-center" name="invresubdesc2" id="invresubdesc2" tabindex="10" autocomplete="off" value="<?=$obj_row["re_sub_description2"];?>" placeholder="กรอกเฉพาะตัวอักษร">

													<input type="text" class="form-control my-1 text-right" name="invresubdesc3" id="invresubdesc3" tabindex="13" autocomplete="off" value="<?=number_format($obj_row["re_sub_description3"],4, '.', '');?>" placeholder="กรอกเฉพาะตัวเลข">
													...
													<input type="text" class="form-control my-1 text-right" name="invresubdesc4" id="invresubdesc4" tabindex="16" autocomplete="off" value="<?=number_format($obj_row["re_sub_description4"],4, '.', '');?>" placeholder="กรอกเฉพาะตัวเลข">
													...
													<input type="text" class="form-control my-1 text-right" name="invresubdesc5" id="invresubdesc5" tabindex="19" autocomplete="off" value="<?=number_format($obj_row["re_sub_description5"],4, '.', '');?>" placeholder="กรอกเฉพาะตัวเลข">
													...
													<input type="text" class="form-control my-1 text-right" name="invresubdesc7" id="invresubdesc7" tabindex="23" autocomplete="off" value="<?=number_format($obj_row["re_sub_description7"],4, '.', '');?>" placeholder="กรอกเฉพาะตัวเลข">
													...
													<input type="text" class="form-control my-1 text-right" name="invresubdesc8" id="invresubdesc8" tabindex="26" autocomplete="off" value="<?=number_format($obj_row["re_sub_description8"],4, '.', '');?>" placeholder="กรอกเฉพาะตัวเลข">
													...
													<input type="text" class="form-control my-1 text-right" name="invresubdesc9" id="invresubdesc9" tabindex="29" autocomplete="off" value="<?=number_format($obj_row["re_sub_description9"],4, '.', '');?>" placeholder="กรอกเฉพาะตัวเลข">
								...
								<div class="col-md-3 pl-1">
									<div class="row">
										<div class="col-md-12">
											...
											<input type="text" class="form-control my-1 text-right" name="amount1" id="amount1" autocomplete="off" tabindex="8" value="<?=number_format($obj_row["re_amount1"],2);?>">
											...
											<input type="text" class="form-control my-1 text-right" name="amount2" id="amount2" autocomplete="off" tabindex="11" value="<?=number_format($obj_row["re_amount2"],2);?>">
											...
											<input type="text" class="form-control my-1 text-right" name="amount3" id="amount3" autocomplete="off" tabindex="14" value="<?=number_format($obj_row["re_amount3"],2);?>">
											...
											<input type="text" class="form-control my-1 text-right" name="amount4" id="amount4" autocomplete="off" tabindex="17" value="<?=number_format($obj_row["re_amount4"],2);?>">
											...
											<input type="text" class="form-control my-1 text-right" name="amount5" id="amount5" autocomplete="off" tabindex="20" value="<?=number_format($obj_row["re_amount5"],2);?>">
											...
											<input type="text" class="form-control my-1 text-right" name="amount6" id="amount6" autocomplete="off" tabindex="24" value="<?=number_format($obj_row["re_amount6"],2);?>">
											...
											<input type="text" class="form-control my-1 text-right" name="amount7" id="amount7" autocomplete="off" tabindex="27" value="<?=number_format($obj_row["re_amount7"],2);?>">
											...
											<input type="text" class="form-control my-1 text-right" name="amount8" id="amount8" autocomplete="off" tabindex="30" value="<?=number_format($obj_row["re_amount8"],2);?>">
												...
												<div class="col-md-12">
													<div class="row">
														<div class="col-md-3">
															<div class="input-group">
																<div class="checkbox">
																	<input type="radio" name="bySelPay" id="byCash" value="1" tabindex="29" <?php if($obj_row["re_typepay"] == 1) echo "checked"; ?>>
														...
														<div class="col-md-4">
															<div class="input-group">
																<div class="checkbox">
																	<input type="radio" name="bySelPay" id="byCheque" value="2" tabindex="30" <?php if($obj_row["re_typepay"] == 2) echo "checked"; ?>>
														...
														<div class="col-md-5">
															<input type="text" class="form-control my-1" name="chequeNo" id="chequeNo" autocomplete="off" tabindex="32" value="<?=$obj_row["re_chequeno"];?>">
														</div>
														<div class="col-md-5">
															<div class="input-group">
																<div class="checkbox">
																	<input type="radio" name="bySelPay" id="byTransfer" value="3" tabindex="31" <?php if($obj_row["re_typepay"] == 3) echo "checked"; ?>>
												...
												<div class="col-md-12">
													<div class="row">
														...
														<div class="col-md-12">
															...
															<div class="input-group">
																<input type="date" class="form-control" name="chequeDate" id="chequeDate" value="<?=$obj_row["re_chequedate"];?>" tabindex="35">
															</div>
														</div>
														<div class="col-md-12">
															<label class="my-1">หมายเหตุ</label>
															<textarea class="form-control" name="ReNote" id="ReNote" rows="2" placeholder="หมายเหตุ" autocomplete="off" tabindex="36"><?=$obj_row["re_note"];?></textarea>
														</div>
													</div>
												</div>
											</div>
											...
											<div class="row">
												...
												<div class="col-md-12">
													<div class="row">
														...
														<div class="col-md-6">
															<input type="text" class="form-control my-1 text-right" name="vatpercent" id="showVatPercent" autocomplete="off" value="<?=number_format($obj_row["re_vatpercent"],2);?>" tabindex="23">
								...
								<div class="col-md-1">
									<div class="row">
										<div class="col-md-12" style="padding-left: 0px;">
											...
											<input type="text" class="form-control my-1 text-right" name="diffvat" id="showDiffVat" autocomplete="off" value="<?=number_format($obj_row["re_differencevat"],2);?>" tabindex="25">
											...
											<input type="text" class="form-control my-1 text-right" name="diffgrand" id="showDiffGrand" autocomplete="off" value="<?=number_format($obj_row["re_differencegrandtotal"],2);?>" tabindex="27">
								...
								<div class="col-md-7">
									<div class="row">
										<div class="col-md-12">
											...
											<input type="text" class="form-control my-1" name="invredesc1" id="invredesc1" autocomplete="off" value="<?=$desc1;?>" tabindex="6">
											<input type="text" class="form-control my-1" name="invredesc2" id="invredesc2" autocomplete="off" value="<?=$desc2;?>" tabindex="7">
											<input type="text" class="form-control my-1" name="invredesc3" id="invredesc3" autocomplete="off" value="<?=$desc3;?>" tabindex="8">
											<input type="text" class="form-control my-1" name="invredesc4" id="invredesc4" autocomplete="off" value="<?=$desc4;?>" tabindex="9">
											<input type="text" class="form-control my-1" name="invredesc5" id="invredesc5" autocomplete="off" value="<?=$desc5;?>" tabindex="10">

											<?php if($cid == 'C014' || $cid == 'C015') { ?>
												<input type="text" class="form-control my-1" name="invredesc6" id="invredesc6" autocomplete="off" value="<?=$desc6;?>" tabindex="11">
												<input type="text" class="form-control my-1" name="invredesc7" id="invredesc7" autocomplete="off" value="<?=$desc7;?>" tabindex="12">
												<input type="text" class="form-control my-1" name="invredesc8" id="invredesc8" autocomplete="off" value="<?=$desc8;?>" tabindex="13">
											<?php } else { ?>
								...
								<div class="col-md-3">
									<div class="row">
										<div class="col-md-12">
											...
											<input type="text" class="form-control text-right my-1" name="amount1" id="amount1" autocomplete="off" value="<?=number_format($obj_row["re_amount1"],2);?>" tabindex="14">
											<input type="text" class="form-control text-right my-1 d-none" name="amountHidden1" id="amountHidden1" value="<?=$obj_row["re_amount1"];?>">
											<input type="text" class="form-control text-right my-1" name="amount2" id="amount2" autocomplete="off" value="<?=number_format($obj_row["re_amount2"],2);?>" tabindex="15">
											<input type="text" class="form-control text-right my-1 d-none" name="amountHidden2" id="amountHidden2" value="<?=$obj_row["re_amount2"];?>">
											<input type="text" class="form-control text-right my-1" name="amount3" id="amount3" autocomplete="off" value="<?=number_format($obj_row["re_amount3"],2);?>" tabindex="16">
											<input type="text" class="form-control text-right my-1 d-none" name="amountHidden3" id="amountHidden3" value="<?=$obj_row["re_amount3"];?>">
											<input type="text" class="form-control text-right my-1" name="amount4" id="amount4" autocomplete="off" value="<?=number_format($obj_row["re_amount4"],2);?>" tabindex="17">
											<input type="text" class="form-control text-right my-1 d-none" name="amountHidden4" id="amountHidden4" value="<?=$obj_row["re_amount4"];?>">
											<input type="text" class="form-control text-right my-1" name="amount5" id="amount5" autocomplete="off" value="<?=number_format($obj_row["re_amount5"],2);?>" tabindex="18">
											<input type="text" class="form-control text-right my-1 d-none" name="amountHidden5" id="amountHidden5" value="<?=$obj_row["re_amount5"];?>">


											<?php if($cid == 'C014' || $cid == 'C015') { ?>
												<input type="text" class="form-control text-right my-1" name="amount6" id="amount6" autocomplete="off" value="<?=number_format($obj_row["re_amount6"],2);?>" tabindex="19">
												<input type="text" class="form-control text-right my-1 d-none" name="amountHidden6" id="amountHidden6" value="<?=$obj_row["re_amount6"];?>">
												<input type="text" class="form-control text-right my-1" name="amount7" id="amount7" autocomplete="off" value="<?=number_format($obj_row["re_amount7"],2);?>" tabindex="20">
												<input type="text" class="form-control text-right my-1 d-none" name="amountHidden7" id="amountHidden7" value="<?=$obj_row["re_amount7"];?>">
												<input type="text" class="form-control text-right my-1" name="amount8" id="amount8" autocomplete="off" value="<?=number_format($obj_row["re_amount8"],2);?>" tabindex="21">
												...
												<div class="col-md-12">
													<div class="row">
														...
														<div class="col-md-7">
															...
															?>
															<input type="text" class="form-control my-1" name="invNo" id="invNo" autocomplete="off" value="<?=$RefinvrcptNo;?>" <?=$roly;?> tabindex="28">
