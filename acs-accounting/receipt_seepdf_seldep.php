...
<head>
	...
	<body>
		...
		<section>
			<div class="container">
				<?php
					$html_title = 'แฟ้มข้อมูล <i class="icofont-caret-right"></i> รายรับ <i class="icofont-caret-right"></i> ใบเสร็จรับเงิน  <i class="icofont-caret-right"></i> เลือกฝ่าย';
