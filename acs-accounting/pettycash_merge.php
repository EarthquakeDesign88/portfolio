...
$html_title = '<b>รายจ่าย</b><i class="icofont-caret-right"></i> รวมใบจ่ายเงินสดย่อย <i class="icofont-caret-right"></i> เลือกฝ่าย';
$icon = '<i class="icofont-paper"></i>';
$sql = " pettycash_tb AS pcash ";

$html_dep_box = __html_dep_box($html_title,'pettycash_merge.php',$icon,"AND pcash.pcash_type = 1 AND pcash.pcash_inv_id IS NULL",$arrDepAll,$sql,"pcash.pcash_dep_id");
...
<body>
		...
		<div class="container">
			<div class="row py-4 px-1" style="background-color: #E9ECEF">
				<div class="col-md-12 pb-4">
					<h3 class="mb-0">
						<i class="icofont-papers"></i>&nbsp;&nbsp;รวมใบจ่ายเงินสดย่อย
                        <button type="button" class="btn btn-outline-info float-right" id="viewHistory">
                        <i class="icofont-ui-folder"></i>&nbsp;&nbsp;<b>ประวัติ</b>
                        </button>
					</h3>
				</div>
				...
				<div class="col-md-12">
					<div class="row">
						...
						<div class="col-md-10">
							...
							<div class="input-group">
								<input type="text" name="search_box" id="searchInput" class="form-control" placeholder="กรอกเลขที่ใบจ่ายเงินสดย่อยที่ต้องการค้นหา" autocomplete="off">
			...
			<div class="row py-4 px-1" style="background-color: #FFFFFF">
                ...
                <div class="col-md-12 mt-2 text-center">
                    <button type="button" class="btn btn-info" id="previewProcessInvoice">ดูตัวอย่าง</button>
                </div>

                <div class="col-md-12 mt-2 text-right">
                    <h5>เลือก 5 รายการ</h5>
                </div>
			</div>
		</div>
	</section>
		...
		<div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
			<div class="modal-content">
				<div class="modal-header">
					<h3 class="modal-title py-2">ตัวอย่าง <span id="pcashHeader"></span></h3>
    ...
    <div id="processInvoiceModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
			<div class="modal-content">
				<div class="modal-header">
					<h3 class="modal-title py-2">ตัวอย่าง <span id="pcashHeader"></span></h3>
	...
	<script type="text/javascript">
				...
				data.forEach(item => {
					...
					table += `
						<tr style="font-size: 12px;">
                            <td>
                                <input type="checkbox" class="select-item" data-id="${item.pCashId}">
                            </td>
							<td>${item.pCashNo}</td>
							<td class="text-right">${countItems}</td>
                            <td class="text-center">${item.pCashPayaName}</td>
        ...
        function renderProcessData(selectedItems) {
            let content = `
                <div class="col-12">
                    ชื่อ-นามสกุล / ชื่อบริษัทในเครือ :
                    <span id="companyName" name="invcompid">
                        <b>บริษัท อรุณ ชัยเสรี คอนซัลติ้ง เอนจิเนียร์ส จำกัด สำนักงานใหญ่</b>
                    </span>
                </div>
                ...
                <div class="col-12">
                    <div class="col-md-12 pt-3" id="showDataPaya">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button type="button" class="btn btn-info clear-btn" title="Clear">
                                    <i class="icofont-close-circled"></i>
                                    <span class="descbtn">&nbsp;&nbsp;Clear</span>
                                </button>
                                <button type="button" class="btn btn-primary add-btn" data-toggle="modal" data-target="#AddPayable" data-backdrop="static" data-keyboard="false" title="เพิ่มผู้รับ">
            ...
            $('#processData').html(previewContent);
        }
		...
		$(document).ready(function() {
            ...
            $('#previewProcessInvoice').click(function (e) {
                e.preventDefault();
                ...
                renderProcessData(selectedItems);
                ...
                //     swal({
                //         title: "พบข้อผิดพลาด",
                //         text: "กรุณาเลือกใบจ่ายเงินสดย่อยอย่างน้อย 1 รายการ",
                //         type: "warning",
                //         closeOnClickOutside: false
                //     });
                // }
