			...
			<form method="POST" name="" id="" action="">
				...
				<div class="row py-4 px-1" style="background-color: #E9ECEF;">
					...
					<div class="col-md-6 text-right">
						<a href="report_invoice_rcpt_ceo.php?cid=<?=$cid;?>&dep=" type="button" class="btn btn-warning d-none" name="btnBack" id="btnBack">
				...
				<div class="row py-4 px-1" style="background-color: #FFFFFF;">
					<div class="col-md-12">
						...
						<div class="table-responsive" id="RptInvoiceRcptCEODesc"></div>
