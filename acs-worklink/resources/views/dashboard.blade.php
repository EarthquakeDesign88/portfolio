...
<div class="row">
    <div class="col-lg-3 col-sm-6">
       <a href="{{ route('positions') }}">
            <div class="card gradient-1">
                <div class="card-body">
                    <h3 class="card-title text-white">ตำแหน่งทั้งหมด</h3>
                    <div class="d-inline-block">
                        <h2 class="text-white">{{ $countPositions }}</h2>
                    </div>
    ...
    <div class="col-lg-3 col-sm-6">
        <a href="{{ route('departments') }}">
            <div class="card gradient-2">
                <div class="card-body">
                    <h3 class="card-title text-white">แผนกทั้งหมด</h3>
                    <div class="d-inline-block">
                        <h2 class="text-white">{{ $countDepartments }}</h2>
                    </div>
    ...
    <div class="col-lg-3 col-sm-6">
        <a href="{{ route('jobQualifications') }}">
            <div class="card gradient-3">
                <div class="card-body">
                    <h3 class="card-title text-white">คุณสมบัติ</h3>
                    <div class="d-inline-block">
                        <h2 class="text-white">{{ $countJobQualifications }}</h2>
                    </div>
    ...
    <div class="col-lg-3 col-sm-6">
        <div class="card gradient-4">
            <div class="card-body">
                <h3 class="card-title text-white">อีเมล</h3>
                <div class="d-inline-block">
                    <h2 class="text-white">{{ $countReadEmails }}</h2>
                </div>
